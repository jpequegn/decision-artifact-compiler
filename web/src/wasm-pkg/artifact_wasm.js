/* @ts-self-types="./artifact_wasm.d.ts" */
 ...
 * @returns {any}
 */
export function diff_artifacts(base, current) {
    ...
    const ret = wasm.diff_artifacts(ptr0, len0, ptr1, len1);
    if (ret[2]) {
 ...
 * @returns {any}
 */
export function validate_artifact(source) {
    const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.validate_artifact(ptr0, len0);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('artifact_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
